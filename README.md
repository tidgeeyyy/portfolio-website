...
1. Make sure that Git is installed and set up correctly on your machine. If not, follow the installation instructions on their official website.
...
| `<h1>`         | The main heading of the page (e.g., "Your Name").                                                    |
